...
public class CharacterController2D : MonoBehaviour
{
	...
	public void Move(float move, bool crouch, bool jump, PlayerMovement.JumpDir jumpDir)
	{
		...
		if (m_Grounded || m_AirControl)
		{
			...
			if (gravityManager.gravityDir == GravityManager.GravityDir.up || gravityManager.gravityDir == GravityManager.GravityDir.down)
			{
